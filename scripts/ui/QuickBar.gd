...
@export var anchor_position: String = "bottom-right"  # "bottom-right" | "bottom-left"
@export var sticky: bool = true
@export var opacity: float = 0.95
@export var safe_area_inset: bool = true
@export var show_when: String = "interactive"  # "always"|"interactive"|"trainingOnly"|"matchOnly"
...
func _apply_layout() -> void:
	var margin := 16.0
	# anchor to bottom right / left with safe area offset
	...
	if anchor_position == "bottom-left":
